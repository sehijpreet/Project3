...
getwd()
setwd('../../../OUTS/E+L+G+P_orig/output/')
...
pred_path <- '../../../Fit_models/E+L+G+P_orig/output/2025-26_pred/'
...
write.csv(Out, "ELGP_orig_2025-26_obs_vs_pred.csv", row.names = FALSE)
...
print(cor_df)
write.csv(cor_df, "ELGP_orig_2025-26_correlations.csv", row.names = FALSE)
