...
pred_path <- '../../../Fit_models/E+L+P_orig/output/2025-26_pred/'
...
write.csv(Out, "ELP_orig_2025-26_obs_vs_pred.csv", row.names = FALSE)
...
print(cor_df)
write.csv(cor_df, "ELP_orig_2025-26_correlations.csv", row.names = FALSE)
