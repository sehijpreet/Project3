...
pred_path <- '../../../Fit_models/E+L+G/output/2025-26_pred/'
...
write.csv(Out, "ELG_2025-26_obs_vs_pred.csv", row.names = FALSE)
...
print(cor_df)
write.csv(cor_df, "ELG_2025-26_correlations.csv", row.names = FALSE)
