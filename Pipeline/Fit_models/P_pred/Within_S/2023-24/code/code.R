...
outdir <- file.path(base,season,"output")
dir.create(outdir,recursive=TRUE,showWarnings=FALSE)
setwd('C:/Users/sidhu/OneDrive - University of Florida/Desktop/PhD data/P3/Pipeline/Fit_models/P_pred/Within_S/2023-24/output')
